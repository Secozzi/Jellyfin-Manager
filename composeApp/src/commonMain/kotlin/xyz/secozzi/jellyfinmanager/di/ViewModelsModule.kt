...
import xyz.secozzi.jellyfinmanager.ui.jellyfin.cover.JellyfinCoverScreenViewModel
...
val ViewModelsModule = module {
    ...
    viewModelOf(::JellyfinCoverScreenViewModel)
    viewModelOf(::JellyfinEpisodeScreenViewModel)
}
